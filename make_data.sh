...
test $? -ne 0 || python3 data/make_data.py ${DATA_OTHER_ARGUMENTS} --max-sample-length ${MAX_SAMPLE_LENGTH} \
    data/texts/corpus_${PROC_DATA_NAME}.txt  data/data/${PROC_DATA_NAME}
