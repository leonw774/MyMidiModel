...
python3 make_array.py --bpe 128 --log "${BASE_PATH}/logs/lmd--snd_ours_1.0.log" --debug "${BASE_PATH}/corpus/lmd--snd_ours_1.0"
...
python3 make_array.py --bpe 128 --log "${BASE_PATH}/logs/snd--lmd_ours_1.0.log" --debug "${BASE_PATH}/corpus/snd--lmd_ours_1.0"
