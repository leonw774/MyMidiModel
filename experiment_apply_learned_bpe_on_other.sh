...
LMD_WPLIKE_PATH="data/corpus/lmd_full_nth96_r32_d96_v16_t24_200_16_posevent_bpe128_wplike_ours_1.0"
...
SND_WPLIKE_PATH="data/corpus/snd_nth96_r32_d96_v16_t24_200_16_posevent_bpe128_wplike_ours_1.0"
mkdir ${BASE_PATH}
...
mkdir "${BASE_PATH}/corpus/lmd--snd_wplike_ours_1.0"
./bpe/apply_vocab \
    $SND_ORIG_PATH \
    "${BASE_PATH}/corpus/lmd--snd_wplike_ours_1.0/corpus" \
    "${LMD_WPLIKE_PATH}/shape_vocab" | tee "${BASE_PATH}/logs/lmd--snd_wplike_ours_1.0.log" -a

python3 text_to_array.py --bpe 128 --log "${BASE_PATH}/logs/lmd--snd_wplike_ours_1.0.log" --debug "${BASE_PATH}/corpus/lmd--snd_wplike_ours_1.0"
...
mkdir "${BASE_PATH}/corpus/snd--lmd_wplike_ours_1.0"
./bpe/apply_vocab \
    $LMD_ORIG_PATH \
    "${BASE_PATH}/corpus/snd--lmd_wplike_ours_1.0/corpus" \
    "${SND_WPLIKE_PATH}/shape_vocab" | tee "${BASE_PATH}/logs/snd--lmd_wplike_ours_1.0.log" -a

python3 text_to_array.py --bpe 128 --log "${BASE_PATH}/logs/snd--lmd_wplike_ours_1.0.log" --debug "${BASE_PATH}/corpus/snd--lmd_wplike_ours_1.0"
