...
if [ $# -ne 5 ]; then
    echo "Expect arguments to be three configuration file name for midi preprocessing, bpe, and training/model setting, and two paths to the model directory and the log file"
    exit 1
fi
